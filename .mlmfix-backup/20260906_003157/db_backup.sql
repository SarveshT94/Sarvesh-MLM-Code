...
\restrict NK4jeVhQ34Oz3dxMNpiqu4SWs8M0pXlaPiZFArInAWFnAEY5v0wCciCDqLulAEh
...
--
-- Name: withdrawal_deductions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.withdrawal_deductions (
    id bigint NOT NULL,
...
ALTER TABLE public.withdrawal_deductions OWNER TO postgres;

--
-- Name: withdrawal_deductions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.withdrawal_deductions ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.withdrawal_deductions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Data for Name: withdrawal_deductions; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.withdrawal_deductions (id, withdrawal_id, user_id, gross_amount, tds_amount, admin_fee_amount, net_payable, tds_rate, admin_rate, created_at) FROM stdin;
1	1	1	500.00	50.00	50.00	400.00	10.00	10.00	2026-09-05 22:13:28.693056
2	2	5	100.00	10.00	10.00	80.00	10.00	10.00	2026-09-05 22:13:28.693056
3	3	1	100.00	10.00	10.00	80.00	10.00	10.00	2026-09-05 22:13:28.693056
4	4	1	100.00	10.00	10.00	80.00	10.00	10.00	2026-09-05 22:13:28.693056
5	5	1	1000.00	100.00	100.00	800.00	10.00	10.00	2026-09-05 22:13:28.693056
6	6	1	2000.00	200.00	200.00	1600.00	10.00	10.00	2026-09-05 22:13:28.693056
7	7	1	5000.00	500.00	500.00	4000.00	10.00	10.00	2026-09-05 22:13:28.693056
8	8	1	2000.00	200.00	200.00	1600.00	10.00	10.00	2026-09-05 22:13:28.693056
9	9	1	1000.00	100.00	100.00	800.00	10.00	10.00	2026-09-05 22:13:28.693056
10	10	1	5000.00	500.00	500.00	4000.00	10.00	10.00	2026-09-05 22:13:28.693056
11	15	1	1000.00	100.00	100.00	800.00	10.00	10.00	2026-09-05 22:13:28.693056
12	16	1	1000.00	100.00	100.00	800.00	10.00	10.00	2026-09-05 22:13:28.693056
\.
...
SELECT pg_catalog.setval('public.commission_plan_id_seq', 111, true);
...
SELECT pg_catalog.setval('public.rank_rules_id_seq', 48, true);
...
--
-- Name: withdrawal_deductions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.withdrawal_deductions_id_seq', 12, true);
...
--
-- Name: withdrawal_deductions withdrawal_deductions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.withdrawal_deductions
    ADD CONSTRAINT withdrawal_deductions_pkey PRIMARY KEY (id);


--
-- Name: withdrawal_deductions withdrawal_deductions_withdrawal_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.withdrawal_deductions
    ADD CONSTRAINT withdrawal_deductions_withdrawal_id_key UNIQUE (withdrawal_id);
...
--
-- Name: idx_wd_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_wd_user ON public.withdrawal_deductions USING btree (user_id);
...
--
-- Name: withdrawal_deductions withdrawal_deductions_withdrawal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.withdrawal_deductions
    ADD CONSTRAINT withdrawal_deductions_withdrawal_id_fkey FOREIGN KEY (withdrawal_id) REFERENCES public.withdraw_requests(id) ON DELETE CASCADE;
...
\unrestrict NK4jeVhQ34Oz3dxMNpiqu4SWs8M0pXlaPiZFArInAWFnAEY5v0wCciCDqLulAEh
