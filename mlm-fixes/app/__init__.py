...
def create_app():
    ...
    app.config["RAZORPAY_KEY_ID"] = cfg.RAZORPAY_KEY_ID
    app.config["RAZORPAY_KEY_SECRET"] = cfg.RAZORPAY_KEY_SECRET
    app.config["PAYMENT_GATEWAY_SECRET"] = cfg.RAZORPAY_WEBHOOK_SECRET
    app.config["MAX_CONTENT_LENGTH"] = 25 * 1024 * 1024  # 25 MB uploads (product images)
    ...
    from app.routes.store_routes import store_bp                 # NEW e-commerce API
    from app.routes.admin.store_routes import admin_store_bp     # NEW admin store pages
